#ifndef FOZZY_FZY2TS_H
#define FOZZY_FZY2TS_H
...
typedef struct model_types_JsModuleHandle {
    uint64_t raw;
} model_types_JsModuleHandle;

typedef struct model_types_JsExportHandle {
    uint64_t raw;
} model_types_JsExportHandle;

typedef struct model_types_JsValueHandle {
    uint64_t raw;
} model_types_JsValueHandle;

typedef struct model_types_JsRegistrationHandle {
    uint64_t raw;
} model_types_JsRegistrationHandle;

typedef struct model_types_JsUtf8View {
    uint64_t ptr;
    size_t len;
} model_types_JsUtf8View;

typedef struct model_types_JsArgv {
